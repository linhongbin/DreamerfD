...
parser.add_argument('--csv1', type=str, default="./example/plot/data/performance/bars/eval_result_20230223-174501.csv")
parser.add_argument('--csv2', type=str, default="./example/plot/data/variation_adaptation/needle_large/eval_result_20230228-022203.csv")
parser.add_argument('--csv3', type=str, default="./example/plot/data/variation_adaptation/needle_small/eval_result_20230227-232128.csv")
parser.add_argument('--csv4', type=str, default="./example/plot/data/variation_adaptation/needle_unregular/eval_result_20230227-201608.csv")
parser.add_argument('--csv5', type=str, default="./example/plot/data/variation_adaptation/needle_unregular2/eval_result_20230228-145136.csv")
...
plt.savefig("./varation_peformance.pdf",bbox_inches='tight')
if args.show:
    plt.show()
# plt.show()
