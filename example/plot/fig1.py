...
parser.add_argument('--csv1', type=str, default="./example/plot/data/performance/learning_curve/run-Dreamer-tag-scalars_eval_sucess_eps_rate.csv")
parser.add_argument('--csv2', type=str, default="./example/plot/data/performance/learning_curve/run-ours-tag-scalars_eval_sucess_eps_rate.csv")
...
plot_line(df1, "DreamerV2", args.linewidth, color='tab:brown')
